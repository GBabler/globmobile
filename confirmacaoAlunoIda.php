...
header('Location: confirmacaoAlunoIda.php?id='.$_SESSION['id'].'');//após a execução do insert, retorna para a página de consulta dos dados.
}
...
if ($sql->rowCount() > 0){  // verifica se o registro existe, maior que zero.
	...
	header('Location: confirmacaoAlunoIda.php?id='.$_SESSION['id'].'');
}
